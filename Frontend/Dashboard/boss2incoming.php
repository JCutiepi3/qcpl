                ...
                <div class="upload">
                    ...
                    <div class="sum_tb">
                        <table aria-describedby="tableDescription">
                            ...
                            $sql = "SELECT category, locator_num, received_date, received_from, type, file_path, boss2_comment, status FROM fileupload WHERE category = 'Incoming' AND status = 'First Review'";
