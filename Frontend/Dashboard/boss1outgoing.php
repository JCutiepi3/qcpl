                    ...
                    <div class="sum_tb">
                        ...
                        <?php
                            ...
                            $sql = "SELECT locator_num, subject, description, received_date, received_from, type, file_path, boss2_comment, category, status 
                                    FROM fileupload 
                                    WHERE status = 'Second Review' AND category = 'Outgoing'
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                $sql_count = "SELECT COUNT(*) AS total_count FROM fileupload WHERE status = 'Second Review' AND category = 'Outgoing'";
