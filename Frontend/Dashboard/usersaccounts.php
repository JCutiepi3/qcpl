...
if ($result_users->num_rows > 0) {
    ...
    while ($row = $result_users->fetch_assoc()) {
        ...
        echo "<td id='us_edit'><center><a href='updateuseradmin.php?id=" . htmlspecialchars($row["id"]) . "'>Edit</a></td>";
        echo "<td id='us_delete'><center><a href='deleteuseradmin.php?id=" . htmlspecialchars($row["id"]) . "'>Delete</a></td>";
        echo "</tr>";
    }
    echo "</tbody>";
    echo "</table>";
